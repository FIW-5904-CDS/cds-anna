...
transplant <- transplant |>
  mutate(across(c(island, site, native, netting,spidpres,webpres),as.factor))
...
##this line is filtering out all data but one point????????????
...
#write a take home summary of graphs/initial findings
